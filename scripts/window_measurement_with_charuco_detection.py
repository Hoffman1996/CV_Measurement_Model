...
class WindowMeasurementSystem:
    ...
    def detect_windows(self, image_path):
        """
        Detect windows using the trained YOLO model via existing utils function.
        ...
        print(f"Detected {len(detections)} windows in {inference_time:.3f}s")
    ...
    def process_image(self, image_path, output_dir=None):
        ...
        # Detect windows
        window_detections, inference_time = self.detect_windows(image_path)
