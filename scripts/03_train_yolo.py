...
def train_yolo_model():
    # === CONFIGURATION ===
    model_arch = 'yolov8n.pt'  # Start with nano for faster training/testing
    ...
    name = 'yolov8n_window_door_detector'
    ...
    if total_images > 0:
        ...
        print(f"Dataset split: Train {train_ratio:.1f}% | Val {val_ratio:.1f}% | Test {test_ratio:.1f}%")
    ...
    with open(summary_file, 'w') as f:
        ...
        f.write(f"Dataset Split: Train {train_ratio:.1f}% | Val {val_ratio:.1f}% | Test {test_ratio:.1f}%\n")
...
if __name__ == "__main__":
    try:
        ...
        print(f"   2. Use best model for inference: {output_dir}/weights/best.pt")
